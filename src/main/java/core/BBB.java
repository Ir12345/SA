...
public class BBB {
	...
	public static void main(String[] args) {
	     ...
	     System.out.println("Debit Card and Bad Credit is anagram? - " + BBB.validate("Debit Card", "Bad Credit"));
	    System.out.println("Охренеть and Не хрена себе is anagram? - " + BBB.validate("Охренеть", "Не хрена себе"));
	       }
}
